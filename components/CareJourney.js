  ...
  return (
    <section className="bg-white py-16 md:py-24">
      <div className="max-w-7xl mx-auto px-6 md:px-10">
        <h2 className="text-3xl md:text-4xl font-bold text-navy text-center mb-24">
          ...
          {cards.map((card) => (
            <div key={card.title} className="relative">
              ...
              <div className="bg-pink-primary/10 rounded-[10px] pt-28 pb-8 px-6 flex flex-col items-center text-center min-h-[260px]">
                ...
                <p className="text-sm font-medium text-black leading-relaxed mb-6 flex-1">
                  {card.body}
                </p>
                <a
                  href="#"
                  className="px-6 py-2 border border-navy text-navy text-sm font-medium rounded-[5px] hover:bg-navy hover:text-white transition-colors"
                >
                  Learn More
                </a>
              </div>
